...
create table if not exists public.location_master (
  ...
  location_type text not null check (location_type in ('stadium', 'event')),
  address text,
  map_url text,
  phone_number text,
  email text,
...
create table if not exists public.schedule (
  ...
  location_id bigint not null references public.location_master(id) on delete restrict,
  description text,
...
create index if not exists idx_schedule_vote_deadline
on public.schedule(vote_deadline);
